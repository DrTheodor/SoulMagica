...
public class NetherStructures {
    ...
    public static void registerStructures(Register<Structure<?>> event) {
         ...
         */
        registerStructure(
                NETHER_VILLAGE, /* The instance of the structure */
                new StructureSeparationSettings(15 /* maximum distance apart in chunks between spawn attempts */,
                        ...
                        145208518 /* this modifies the seed of the structure so no two structures always spawn over each-other. Make this large and unique. */),
                true);
