 ...
 */
public class NetherVillagePieces {
    /*
     ...
     */
    private static final ResourceLocation OUTPOST = new ResourceLocation(SoulMagica.MOD_ID, "village_outpost");
    private static final ResourceLocation BARTER_HOUSE = new ResourceLocation(SoulMagica.MOD_ID, "barter_house");
    private static final ResourceLocation SMALL_HOUSE = new ResourceLocation(SoulMagica.MOD_ID, "small_vill_house");
    //private static final ResourceLocation RIGHT_SIDE = new ResourceLocation(SoulMagica.MOD_ID, "run_down_house_right_side");
    private static final Map<ResourceLocation, BlockPos> OFFSET = ImmutableMap.of(OUTPOST, new BlockPos(0, 1, 0), BARTER_HOUSE, new BlockPos(15, 1, 15), SMALL_HOUSE, new BlockPos(10, 1, 0));
    ...
    public static void start(TemplateManager templateManager, BlockPos pos, Rotation rotation, List<StructurePiece> pieceList, Random random) {
        ...
        pieceList.add(new NetherVillagePieces.Piece(templateManager, OUTPOST, blockpos, rotation));

        rotationOffSet = new BlockPos(-15, 0, 0).rotate(rotation);
        blockpos = rotationOffSet.add(x, pos.getY(), z);
        pieceList.add(new NetherVillagePieces.Piece(templateManager, BARTER_HOUSE, blockpos, rotation));

        rotationOffSet = new BlockPos(15, 0, 0).rotate(rotation);
        blockpos = rotationOffSet.add(x, pos.getY(), z);
        pieceList.add(new NetherVillagePieces.Piece(templateManager, SMALL_HOUSE, blockpos, rotation));
    }
    ...
    public static class Piece extends TemplateStructurePiece {
        ...
        public Piece(TemplateManager templateManagerIn, ResourceLocation resourceLocationIn, BlockPos pos, Rotation rotationIn) {
            super(NetherStructures.NVP, 0);
            this.resourceLocation = resourceLocationIn;
            BlockPos blockpos = NetherVillagePieces.OFFSET.get(resourceLocation);
        ...
        public Piece(TemplateManager templateManagerIn, CompoundNBT tagCompound) {
            super(NetherStructures.NVP, tagCompound);
