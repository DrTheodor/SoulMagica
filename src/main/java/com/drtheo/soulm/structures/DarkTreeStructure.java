...
public class DarkTreeStructure extends Structure<NoFeatureConfig> {
    public DarkTreeStructure(Codec<NoFeatureConfig> codec) {
        super(codec);
    }
    ...
    public  IStartFactory<NoFeatureConfig> getStartFactory() {
        return DarkTreeStructure.Start::new;
    }
...
//    }
    ...
    public static class Start extends StructureStart<NoFeatureConfig>  {
        ...
        public void func_230364_a_(DynamicRegistries dynamicRegistryManager, ChunkGenerator generator, TemplateManager templateManagerIn, int chunkX, int chunkZ, Biome biomeIn, NoFeatureConfig config) {
            ...
            DarkTreePieces.start(templateManagerIn, blockpos, rotation, this.components, this.rand);
            ...
            System.out.println("Dark Tree at: " + (blockpos.getX()) + " " + blockpos.getY() + " " + (blockpos.getZ()));
        }
