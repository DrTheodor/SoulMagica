package com.drtheo.soulm.armor;
...
public enum ModArmorMaterial implements IArmorMaterial {
    ...
    DARK_METAL(SoulMagica.MOD_ID + ":dark_metal", 25, new int[] { 2, 5, 6, 2 }, 18,
            SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 0, () -> { return Ingredient.fromItems(ModItems.DARK_METAL.get()); },0);
