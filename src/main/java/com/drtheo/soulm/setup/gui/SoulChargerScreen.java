...
public class SoulChargerScreen extends ContainerScreen<SoulChargerContainer> {

    private static final ResourceLocation BACKGROUND_TEXTURE = new ResourceLocation(SoulMagica.MOD_ID,
            "textures/gui/soul_pedestal.png");
     ...
     */
    public SoulChargerScreen(SoulChargerContainer screenContainer, PlayerInventory inv, ITextComponent titleIn) {
