...
public class Registration {
    ...
    public static final RegistryObject<Item> SOUL_CHARGER_ITEM = ITEMS.register("soul_charger", () -> new BlockItem(BlockInit.SOUL_CHARGER.get(), new Item.Properties().group(SoulMagica.TAB)));
    public static final RegistryObject<Item> ITEM_PEDESTAL_ITEM = ITEMS.register("item_pedestal", () -> new BlockItem(BlockInit.ITEM_PEDESTAL.get(), new Item.Properties().group(SoulMagica.TAB)));
