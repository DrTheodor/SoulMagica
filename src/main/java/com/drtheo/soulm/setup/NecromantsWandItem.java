...
public class NecromantsWandItem extends Item {
    ...
    public void cancelPlayerFallDamage(LivingFallEvent event)
    {
        if (event.getEntity() instanceof PlayerEntity)
        {
            ...
            if (player.getHeldItem(Hand.MAIN_HAND).getItem() == Registration.NECROMANTS_WAND.get() || player.getHeldItem(Hand.OFF_HAND).getItem() == Registration.NECROMANTS_WAND.get())
            {
