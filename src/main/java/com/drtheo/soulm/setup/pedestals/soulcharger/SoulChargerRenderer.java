...
@OnlyIn(Dist.CLIENT)
public class SoulChargerRenderer extends TileEntityRenderer<SoulChargerTileEntity> {

    private float degrees;

    public SoulChargerRenderer(TileEntityRendererDispatcher rendererDispatcherIn) {
     ...
     */
    @Override
    public void render(SoulChargerTileEntity tileEntityIn, float partialTicks, MatrixStack matrixStackIn,
