...
public class SoulChargerContainer extends Container {

    public final SoulChargerTileEntity tileEntity;
     ...
     * hotbar.
     */
    public SoulChargerContainer(final int windowId, final PlayerInventory playerInv,
                                final SoulChargerTileEntity tileEntityIn) {
        super(ModContainerTypes.SOUL_CHARGER.get(), windowId);
    ...
    public SoulChargerContainer(final int windowId, final PlayerInventory playerInv, final PacketBuffer data) {
     ...
     * happen.
     */
    private static SoulChargerTileEntity getTileEntity(final PlayerInventory playerInv, final PacketBuffer data) {
        Objects.requireNonNull(playerInv, "playerInv cannot be null");
        Objects.requireNonNull(data, "data cannot be null");
        final TileEntity tileAtPos = playerInv.player.world.getTileEntity(data.readBlockPos());
        if (tileAtPos instanceof SoulChargerTileEntity) {
            return (SoulChargerTileEntity) tileAtPos;
        }
    ...
    public boolean canInteractWith(PlayerEntity playerIn) {
        return isWithinUsableDistance(canInteractWithCallable, playerIn, BlockInit.SOUL_CHARGER.get());
    }
