...
public class SoulChargerTileEntity extends LockableLootTileEntity implements IClearable, INamedContainerProvider {
    ...
    public SoulChargerTileEntity(TileEntityType<?> tileEntityTypeIn) {
        super(tileEntityTypeIn);
    }

    public SoulChargerTileEntity() {
        this(ModTileEntityTypes.SOUL_CHARGER.get());
    }
    ...
    protected ITextComponent getDefaultName() {
        return new TranslationTextComponent("container." + SoulMagica.MOD_ID + ".soul_charger");
    }

    /* This method creates the container for this tile entity */
    @Override
    protected Container createMenu(int id, PlayerInventory player) {
        return new SoulChargerContainer(id, player, this);
    }
    ...
    private void read(CompoundNBT nbtCompound) {
        this.items = NonNullList.withSize(this.getSizeInventory(), ItemStack.EMPTY);
        ItemStackHelper.loadAllItems(nbtCompound, this.items);
    }
